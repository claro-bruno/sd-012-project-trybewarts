...
botao.addEventListener('click', () => {
  ...
  if (inputLogin.value !== login || inputSenha.value !== senha) { // correção operador logico
...
function getMaterias() {
  ...
  return materiaSelecionadas.join(', '); // correção join
}
...
submitBtn.addEventListener('click', (e) => {
  ...
  document.querySelector('#returnRate').innerText = `Matérias: ${object.mateira}`; // correção ordem dos itens
